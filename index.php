      ...
      <div class="card" style="width: 30rem; top:100px;">
       ...
       <form  action="create.php" id="registrationForm" name="contact" method="post">
           <div class="card-body form-group">
            ...
            <input type="text" name="name" id="name" class="form-control form-rounded" placeholder="enter name" required="">

            
            <br>
            <label for="email">Email  </label>
            <input type="email" name="email" id="email" class="form-control form-rounded" placeholder="email" required="">

            <br>
            <label for="contact"> Mobile no. </label>
            <input type="Phone" name="contact" id="contact" class="form-control form-rounded" placeholder="contact number" required="">

            <br>

            <label for="dob"> DOB </label>
            <input type="date" name="dob" id="dob" class="form-control form-rounded"  placeholder="dd-mm-yyyy" required="" onblur ="ageCount()">
